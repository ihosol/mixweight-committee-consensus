...
import (
	...
	adaptivecommitteetypes "chain-five-three/x/adaptivecommittee/types" // manual module (not app-wired)
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					BeginBlockers: []string{
						...
						// chain modules
						adaptivecommitteetypes.ModuleName, // manual module (not app-wired)
