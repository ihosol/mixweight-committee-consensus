...
func NewRootCmd() *cobra.Command {
	...
	// AdaptiveCommittee is also manually wired in app/app.go, so expose its
	// legacy tx/query CLI commands explicitly on the client side.
	moduleBasicManager[adaptivecommitteetypes.ModuleName] = adaptivecommittee.NewAppModuleBasic(clientCtx.Codec)
