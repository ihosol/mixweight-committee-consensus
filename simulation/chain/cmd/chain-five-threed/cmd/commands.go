...
import (
	...
	adaptivecommitteecli "chain-five-three/x/adaptivecommittee/client/cli"
...
func queryCommand() *cobra.Command {
	...
	cmd.AddCommand(
		...
		adaptivecommitteecli.GetQueryCmd(adaptivecommitteetypes.StoreKey),
	)
